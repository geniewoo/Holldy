$(function() {
    ...
    socket.on('isThereAdmin', function(clientID) {
        ...
        window.open('/admin12345abcde/helpPopUp?clientID=' + clientID,"상담 " + clientID, "fullscreen=no,toolbar=no,status=no,menubar=no,scrollbars=no,resizeable=no,width=300,height=600");
    });
